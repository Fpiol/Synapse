...
export default function OrderConfirmationPage({ cartCount, customerInfo, onShop, onMenuClick, siteTitle }: OrderConfirmationPageProps) {
...
function Header({ cartCount, onMenuClick, siteTitle }: HeaderProps) {
  return (
