...
export default function PlaceholderPage({ title, content, onBack, onMenuClick, cartCount, siteTitle = 'World Peas' }: PlaceholderPageProps) {
  return (
    <div className="bg-[#ffffff] relative size-full">
      ...
      <div className="absolute left-0 right-0 top-[225px] bottom-4 overflow-y-auto">
        <div className="p-8">
          <h2 className="text-[24px] font-['Newsreader:Regular',_sans-serif] text-[#426b1f] mb-6 text-center">{title}</h2>
          {content ? (
            <div className="text-[16px] font-['Inter:Regular',_sans-serif] text-[#333333] leading-relaxed whitespace-pre-wrap">
              {content}
            </div>
          ) : (
            <p className="text-[16px] font-['Inter:Regular',_sans-serif] text-[#757575] text-center">
